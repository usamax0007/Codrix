 ...
 */
class ManageServiceSettings extends Page
{
    protected string $view = 'filament.pages.manage-service-settings';

    protected static string|UnitEnum|null $navigationGroup = 'Settings';

    protected static ?string $navigationLabel = 'Services Settings';
    ...
    {
        $this->form->fill($this->getRecord()?->attributesToArray() ?? ServiceSetting::defaults());
    }
                ...
                Form::make([
                    ...
                    Section::make('Bottom Content')
                        ->schema([
                            ...
                            Textarea::make('footer_content')->label('Content')->rows(4),
                        ]),
                    Section::make('SEO')
                        ->schema([
    ...
    public function save(): void
    {
        ...
        $record = $this->getRecord() ?? new ServiceSetting;
    ...
    public function getRecord(): ?ServiceSetting
    {
        return ServiceSetting::query()->first();
    }
}
