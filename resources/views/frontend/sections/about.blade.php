    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid lg:grid-cols-2 gap-12 items-center scroll-reveal">
            ...
            <div class="grid grid-cols-2 gap-4">
                <img src="{{ $aboutSettings->image1Url() }}" alt="{{ $siteSettings->site_name }} development team collaborating" class="rounded-xl w-full"
                     width="319"
                     height="212"
                     loading="lazy"
                     decoding="async"   >
                <img src="{{ $aboutSettings->image2Url() }}" alt="Modern software development workspace"   class="rounded-xl w-full mt-8"
                     width="319"
                     height="319"
                     loading="lazy"
                     decoding="async">
